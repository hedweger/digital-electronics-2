...
ISR(ADC_vect)
{
    ...
    if (ADC<40) {lcd_gotoxy(8, 1); lcd_puts("       "); lcd_gotoxy(8, 1); lcd_puts("Right"); }
    else if (ADC > 90 & ADC < 110) {lcd_gotoxy(8, 1); lcd_puts("       "); lcd_gotoxy(8, 1); lcd_puts("Up"); }
    else if (ADC > 230 & ADC < 260) {lcd_gotoxy(8, 1); lcd_puts("       "); lcd_gotoxy(8, 1); lcd_puts("Down"); }
